...
class NewMainListPage extends StatefulWidget {
  final Widget child;

  const NewMainListPage({
    Key? key,
    required this.child,
  }) : super(key: key);

  @override
  State<NewMainListPage> createState() => _NewMainListPageState();
}

class _NewMainListPageState extends State<NewMainListPage> {
  String fName = '';
