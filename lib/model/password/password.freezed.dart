...
class _$_Password extends _Password {
  ...
  @override
  String toString() {
    return 'Password(id: $id, path: $path, siteName: $siteName, siteUrl: $siteUrl, email: $email, password: $password, imageUrl: $imageUrl, note: $note, category: $category, favourite: $favourite, usage: $usage, lastUsed: $lastUsed, timeAdded: $timeAdded)';
  }
